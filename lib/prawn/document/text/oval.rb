...
module Prawn
  class Document
    module Text
      ...
      #       :width
      #       :height
      #       :at => upper left corner of the bounding box around the ellipse
      #       :center => center of the ellipse (overrides :at)
      #       :overflow => :truncate or :ellipses. defaults to :truncate
      #       :crop => space between top of the oval and the first line.
      #                defaults to 0
      #       :leading => ie: @document.font.height * 0.5, defaults to 0
      #       :kerning => true or false. defaults to false
      #       :align => :center, :left, or :right. defaults to :center
